Termucoin Core version 1.14.8 is now available from:

  <https://github.com/termucoin/termucoin/releases/tag/v1.14.8/>

This is a new minor version release. Termucoin users on any platform are
...
Several important updates have been added to Termucoin Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Termucoin Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Termucoin Core
...
In previous versions of Termucoin Core, orphan transactions were processed in a
...
Termucoin Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Termucoin Core.
...
* Termucoin Core now supports compilation with C++14 and C++17, if you select
