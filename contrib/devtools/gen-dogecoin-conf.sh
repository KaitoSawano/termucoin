...
TERMUBITD=${TERMUBITD:-$BINDIR/termubitd}
SHARE_DIR=${SHARE_DIR:-$TOPDIR/share}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_DIR/termubit.conf}
...
then
  ...
  echo -e "To safely generate a termubit.conf file, please commit your changes to $TERMUBITD, rebuild, then run this script again.\n"
fi

echo 'Generating example termubit.conf file in share/'
...
##
## termubit.conf configuration file.
## Generated by contrib/devtools/gen-termubit-conf.sh.
##
...
# parse the output from termubitd --help
