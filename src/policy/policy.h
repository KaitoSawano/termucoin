...
/** Recommended transaction fee by Termucoin Core developers
  *
 ...
 *
 *  Termucoin:    Increment mempool limits and accept RBF in steps of 0.0001 TERM
...
/**
 * Termucoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Termucoin: Default hard dust limit that is evaluated when considering whether
