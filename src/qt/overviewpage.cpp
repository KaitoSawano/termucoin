...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Termucoin Core repository on GitHub"),
        tr("Services that claim to double your termucoins are always ponzi schemes")
    };
